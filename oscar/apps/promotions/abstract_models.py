...
class AbstractLinkedPromotion(models.Model):
...
class AbstractPagePromotion(AbstractLinkedPromotion):
    """
...
class AbstractKeywordPromotion(AbstractLinkedPromotion):
    """
...
class AbstractPromotion(models.Model):
    ...
    """
    _type = 'Promotion'
    keywords = generic.GenericRelation('promotions.KeywordPromotion', verbose_name=_('Keywords'))
    pages = generic.GenericRelation('promotions.PagePromotion', verbose_name=_('Pages'))
...
class AbstractRawHTML(AbstractPromotion):
    """
...
class AbstractImage(AbstractPromotion):
    """
...
class AbstractMultiImage(AbstractPromotion):
    """
...
class AbstractSingleProduct(AbstractPromotion):
...
class AbstractTabbedBlock(AbstractPromotion):
